  ...
  return (
    ...
    >
      ...
      <div className={classes.rightContainer}>
        <div>
          <Typography variant="h5">
            <NumberFormat value={showSwap ? swapData.amount : amount} displayType="text" thousandSeparator="," suffix={` ${showSwap ? swapData.currency.symbol : currency.symbol}`} decimalScale={5} />
          </Typography>
          <Typography variant="subtitle2">
